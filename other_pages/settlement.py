...
class page4_settlement:
    def __init__(self):
        ...
        # for request form
        self.REQUEST_FORM_ORDER = ['timestamp','date_of_paymnt','name','request_id','amount','department','table_entry','remark']
        ...
        # for payments
        self.PAYMENT_ORDER = ['timestamp','date_of_paymnt','amount',
    ...
    def home(self):
        ...
        if 'acc_ic' in st.session_state.user['roles']:
            st.button("Make Settlements",on_click=self.go2_subpage,args=['makePayments'],key='accic_button')
        st.markdown('---')
